...
from transformers.modeling_el_bert import BertForSequenceClassification
...
class ModelArguments:
    ...
    loss_type: Optional[str] = field(
        default='default', metadata={"help": "Loss function to use for fine-tuning training the model"}
    )

    dl_gamma: Optional[float] = field(
        default=1.0, metadata={"help": "Gamma for dice loss"}
    )
...
def main():
    ...
    print('config', config)
    config.num_hidden_layers = 2 # set 2 2 layer 
    ...
    model.bert.init_weights() #  reinitialize model 
