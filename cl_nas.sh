...
train_early_exit=0
train_agent=1
CL_IDX=3 # only learn the last layer  switch
...
for ERROR_PENALTY in -10.0 #0.0 -0.1 -0.5 -1.0 #0.11 0.115 0.12  #0.105  #0.001 0.01 0.1 #0.5 1.0 10.0 #0.1 0.01 0.001  #0.0002 0.0003 0.0005 0.0007 #0.1 0.01 0.001 # 5 #  0.0002 # 0.001 0.0001  #0.0002 #0.0005 0.0007  # 0.0005 0.0009 #  0.001 # 0.01 0.1 1.0 #  0.005 0.01 0.05 # 0.1  0.2 0.5  2.0 5.0 10.0  # 10.0 50.0 100.0 1000.0
do
...
CUDA_VISIBLE_DEVICES=$GPU python ./run_glue_theseus.py --cl_idx $CL_IDX --bound_alpha $BD_ALPHA --logging_paths  --logging_steps 800 --error_penalty $ERROR_PENALTY  \
  --model_name_or_path  "$SECOND_STAGE_OUTPUT" --fp16  \
