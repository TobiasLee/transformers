...
from .losses import FocalLoss, SelfAdjDiceLoss, CourageLoss, ReweightLoss, MixedLoss
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def set_loss_type(self, loss_type, loss_config=None):
        ...
        if labels is not None:
            ...
            if self.loss_type == 'default':
                ...
                if self.loss_type == 'fl':
                    ...
                    loss_fct = ReweightLoss(**self.loss_config)
                elif self.loss_type == 'mixed':
                    loss_fct = MixedLoss(**self.loss_config)
                loss = loss_fct(logits.view(-1, self.num_labels), labels.view(-1))
